...
public class MongoDBReader extends Reader {
    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            LOG.info("==============================Job MongoDB database is :"+ database +"================================");
            //获取认证库
            String authDb =  originalConfig.getString(KeyConstant.MONGO_AUTHDB, database);
            LOG.info("==============================Job MongoDB AuthDB is :"+ authDb +"================================");
    ...
    public static class Task extends Reader.Task {
        ...
        public void init() {
            ...
            LOG.info("==============================Task MongoDB database is :"+ database +"================================");
            this.authDb = readerSliceConfig.getString(KeyConstant.MONGO_AUTHDB, this.database);
            LOG.info("==============================Task MongoDB authDb is :"+ authDb +"================================");
