...
public class ESWriter extends Writer {
    ...
    public static class Task extends Writer.Task {
        ...
        @Override
        public void startWrite(RecordReceiver recordReceiver) throws Exception {
        ...
        private long doBatchInsert(final List<Record> writerBuffer) throws Exception {
            ...
            for (Record record : writerBuffer) {
                ...
                if(record.getColumnNumber() != columnList.size()){
                    throw new Exception("查询字段个数与写入ES字段个数不一致，请检查后重试");
                }
