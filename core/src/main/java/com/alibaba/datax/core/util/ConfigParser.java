...
public final class ConfigParser {
     ...
     */
    public static Configuration parse(final String jobPath,final String tableName) {
        Configuration configuration = ConfigParser.parseJobConfig(jobPath,tableName);
        configuration.merge(
    ...
    public static Configuration parseJobConfig(final String path,final String tableName) {
        String jobContent = getJobContent(path);

        Configuration config = Configuration.from(jobContent,tableName);
