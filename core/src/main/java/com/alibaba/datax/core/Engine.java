...
public class Engine {
    ...
    public static void entry(final String[] args,String tableName) throws Throwable {
        ...
        //根据指定的job的json文件解析，获得任务配置
        Configuration configuration = ConfigParser.parse(jobPath,tableName);
